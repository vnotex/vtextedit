...
// mapping: the walker uses it to place highlights and previews, and
// MarkdownUtils::fetchImageLinks() uses it to locate images in raw text.
// testWalkerAndSnapshotAgreeOnRegions() gates the two against each other.
