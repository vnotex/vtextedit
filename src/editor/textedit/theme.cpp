...
{
    static const auto indexOfEditorStyleEnum = Theme::staticMetaObject.indexOfEnumerator("EditorStyle");
...
Format Theme::loadStyleFormat(const QJsonObject &p_obj)
{
    ...
    fmt.m_selectedBackgroundColor = readColor(p_obj.value(QStringLiteral("selected-background-color")));
    return fmt;
}

void Theme::loadMarkdownSyntaxStyles(const QJsonObject &p_obj)
{
    static const auto indexOfMarkdownStyleEnum = Theme::staticMetaObject.indexOfEnumerator("MarkdownSyntaxStyle");
