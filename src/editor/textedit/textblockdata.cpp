...
KSyntaxHighlighting::State TextBlockData::getSyntaxState() const
{
    return m_syntaxState;
}

void TextBlockData::setSyntaxState(KSyntaxHighlighting::State p_state)
{
    m_syntaxState = p_state;
}

int TextBlockData::getFoldingIndent() const
{
    return m_foldingIndent;
}

void TextBlockData::setFoldingIndent(int p_indent)
{
    m_foldingIndent = p_indent;
}
...
void TextBlockData::clearFoldings()
{
    m_foldings.clear();
}
...
const QVector<TextBlockData::Folding> &TextBlockData::getFoldings() const
{
    return m_foldings;
}

bool TextBlockData::isMarkedAsFoldingStart() const
{
    return m_markedAsFoldingStart;
}

void TextBlockData::setMarkedAsFoldingStart(bool p_set)
{
    m_markedAsFoldingStart = p_set;
}
