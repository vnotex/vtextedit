...
EditorExtraSelection::EditorExtraSelection(VTextEditor *p_editor)
    : ExtraSelectionInterface(),
      m_editor(p_editor)
{

}

QTextCursor EditorExtraSelection::textCursor() const
{
    return m_editor->m_textEdit->textCursor();
}

QString EditorExtraSelection::selectedText() const
{
    return m_editor->m_textEdit->selectedText();
}

void EditorExtraSelection::setExtraSelections(const QList<QTextEdit::ExtraSelection> &p_selections)
{
