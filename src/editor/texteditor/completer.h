...
namespace vte
{
    ...
    public:
        ...
        void triggerCompletion(CompleterInterface *p_interface,
        ...
        // Helper function to generate completion candidates excluding the word specified
        // by [p_wordStart, p_wordEnd).
        static QStringList generateCompletionCandidates(CompleterInterface *p_interface,
                                                        int p_wordStart,
                                                        int p_wordEnd,
                                                        bool p_reversed);
