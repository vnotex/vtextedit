...
QString VscodeInputMode::name() const
{
    return QStringLiteral("vscode");
}

InputMode VscodeInputMode::mode() const
{
...
EditorMode VscodeInputMode::editorMode() const
{
    return m_mode;
}
...
void VscodeInputMode::preKeyPressDefaultHandle(QKeyEvent *p_event)
{
    Q_UNUSED(p_event);
}

void VscodeInputMode::postKeyPressDefaultHandle(QKeyEvent *p_event)
{
    Q_UNUSED(p_event);
}
...
QSharedPointer<InputModeStatusWidget> VscodeInputMode::statusWidget()
{
    return nullptr;
}
