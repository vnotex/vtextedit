...
namespace KateViI
{
    ...
    public:
        ...
        // Remove text specified in @p_range. If @p_blockWise is true, will remove a text block
        // on the basis of columns.
        ...
        // Transform @p_column to the real column, where each tab only counts as one character.
        ...
        virtual bool replaceText(const KateViI::Range &p_range, const QString &p_text, bool p_blockWise = false) = 0;
        ...
        // Align current line if there is no selection. Otherwise, align selection range.
