...
/**
 * for encoding keypresses w/ modifiers into an internal QChar representation
 * and back again to a descriptive text string
 */
class KATEVI_EXPORT KeyParser {
private:
  KeyParser();

public:
  static KeyParser *self();
  ~KeyParser() { m_instance = nullptr; }
