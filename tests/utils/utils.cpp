...
QString utils::getCppText() {
  return "#include <QTimer>\n"
         ...
         "using namespace vte;\n"
         "\n"
         "// START Here is a long long comment which is used to test word wrap within a block very "
         "long long long IndicatorsBorder::IndicatorsBorder(IndicatorsBorderInterface *p_interface "
         "word word word word wrap wrap here is the end of this long line END\n"
